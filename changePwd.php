    	...
    	<div class="container">
    		<div class="row no-gutters">			
    			<div class="col-md-7 featured-top"> 
					...
					<form action="helper/saveCustomerPass/index.php" name='custsign' class="request-form ftco-animate bg-primary login_wrapper" method='POST' onsubmit='javascript:return checkCusPass();'>
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" id='custpwd' name='custpwd' autocomplete='off' >
						</div>
						<div class="form-group">
							<label for="" class="label">Confirm Password<span style='color:red;'>*</span></label>
							<input type="password" class="form-control" id='custconfpassword' name='custconfpassword' autocomplete='off' >
						</div>
						...
						<div class="form-group">
							...
							<input type='submit' value='Save' class="form-control btn">
						</div>
					</form>
				</div>
