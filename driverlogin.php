  ...
  <body>    
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	     ...
	     <?php 
			$lnk='login';include_once("header.php");
      ...
      <section class="ftco-section ftco-no-pt bg-light login_wrapper">
    	<div class="container">
    		<div class="row no-gutters">
				...
				<h2>Driver Login</h2>
					<form action="helper/driverLogin/index.php" name='drivsign' class="request-form ftco-animate bg-primary login_wrapper" method='POST' onsubmit='javascript:return checkDrivlogin();'>
						...
						<?php if(isset($_GET['e']) && $_GET['e']==1){echo "<label style='color:red;'>Invalid Credentials.</label>";}?>						
						</div>						
						<div class="form-group">
							<label for="" class="label">Email&nbsp;<span style='color:red;'>*</span></label>
							<input type="text" class="form-control" id='drivemail' name='drivemail'>
						</div>
						<div class="form-group">
							<label for="" class="label">Password&nbsp;<span style='color:red;'>*</span></label>
							<input type="password" class="form-control" id='drivpwd' name='drivpwd'>
						</div>
						<div class="text-right">
							<input  type="hidden" name="posted" value="true">
							<input type='button' value='Forgot Password' class=" btn" style='width:30%;' onclick='javascript:window.location="driverforgotPwd.php";'>
							<input type='submit' value='Login' class="btn" style='width:20%;'>						
						</div>
					</form>
				</div>
				...
				<h2>&nbsp;</h2>
					...
					<div class="services services-2 w-100 text-center" style='margin-top:20px;'>
						...
						<div class="text w-100">
						<h3 class="heading mb-2"  onclick="window.location.href='driversignup.php'" style='cursor:pointer;'>Driver Signup</h3>
