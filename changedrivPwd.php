    	...
    	<div class="container">
    		<div class="row no-gutters">			
    			<div class="col-md-7 featured-top"> 
					...
					<form action="helper/savedriverPass/index.php" name='drivsign' class="request-form ftco-animate bg-primary login_wrapper" method='POST' onsubmit='javascript:return checkDrivPass();'>
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" id='drivpwd' name='drivpwd' autocomplete='off' >
						</div>
						<div class="form-group">
							<label for="" class="label">Confirm Password<span style='color:red;'>*</span></label>
							<input type="password" class="form-control" id='drivconfpassword' name='drivconfpassword' autocomplete='off' >
						</div>
