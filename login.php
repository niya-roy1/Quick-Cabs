  ...
  <body>    
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	     ...
	     <?php $lnk='login';include_once("header.php");
    	...
    	<div class="container">
    		<div class="row no-gutters">
				...
				<h2>Customer Login</h2>
					<form action="helper/customerLogin/index.php" name='custsign' class="request-form ftco-animate bg-primary login_wrapper" method='POST' onsubmit='javascript:return checkCuslogin();'>
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" id='cuspwd' name='cuspwd'>
						</div>
						<div class="text-right">
							<input  type="hidden" name="posted" value="true">
							<input type='button' value='Forgot Password' class=" btn" style='width:30%;' onclick='javascript:window.location="forgotPwd.php";'>
